//! Security-Aware Audit Middleware (AU-2, AU-3, AU-9, AU-12)
//!
...
//! # Modules
//!
//! - [`integrity`]: Cryptographic protection for audit logs (AU-9)
//!
//! # Usage
//!
...
//! ```
//!
//! ## Signed Audit Records (AU-9)
//!
//! ```ignore
//! use barbican::audit::integrity::{AuditChain, AuditIntegrityConfig};
//!
//! let config = AuditIntegrityConfig::new(b"your-32-byte-secret-key-here!!");
//! let mut chain = AuditChain::new(config);
//!
//! // Records are signed and chained for tamper detection
//! let record = chain.append("auth.login", "user@example.com", "/api/login", "POST", "success", "192.168.1.1", None);
//!
//! // Verify integrity at any time
//! assert!(chain.verify_integrity().unwrap().is_valid());
//! ```
//!
...
// AU-9: Audit log integrity protection
pub mod integrity;
