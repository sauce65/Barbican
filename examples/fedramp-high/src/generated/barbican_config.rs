...
impl GeneratedConfig {
    ...
    /// Application name
    pub const APP_NAME: &'static str = "hello-fedramp-high";

    /// Application version
    pub const APP_VERSION: &'static str = "0.1.0";

    /// Compliance profile
    pub const PROFILE: ComplianceProfile = ComplianceProfile::FedRampHigh;
    ...
    pub const SESSION_TIMEOUT_SECS: u64 = 600;
