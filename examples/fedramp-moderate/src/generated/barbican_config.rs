...
impl GeneratedConfig {
    ...
    /// Application name
    pub const APP_NAME: &'static str = "hello-fedramp-moderate";

    /// Application version
    pub const APP_VERSION: &'static str = "0.1.0";

    /// Compliance profile
    pub const PROFILE: ComplianceProfile = ComplianceProfile::FedRampModerate;
    ...
    pub const SESSION_TIMEOUT_SECS: u64 = 900;
    ...
    pub const LOCKOUT_DURATION_SECS: u64 = 1800;
    ...
    pub const MFA_REQUIRED: bool = true;
